...
func noPanicRangeOverFunc[V any](t *testing.T, name string, fn any) {
	...
	case func() func(yield func(netip.Prefix) bool):
		iterFunc()(func(prefix netip.Prefix) bool {
			return true
		})
	case func() func(yield func(netip.Prefix, V) bool):
		iterFunc()(func(prefix netip.Prefix, v V) bool {
			return true
		})
	case func(netip.Prefix) func(yield func(netip.Prefix) bool):
		pfx := mpp("1.2.3.4/32")
		iterFunc(pfx)(func(prefix netip.Prefix) bool {
			return true
		})
	case func(netip.Prefix) func(yield func(netip.Prefix, V) bool):
		pfx := mpp("1.2.3.4/32")
		iterFunc(pfx)(func(prefix netip.Prefix, v V) bool {
			return true
		})
	default:
