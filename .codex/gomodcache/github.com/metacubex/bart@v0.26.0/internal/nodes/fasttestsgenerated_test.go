...
// helpers
func (n *FastNode[V]) all4() func(yield func(netip.Prefix, V) bool) {
...
func (n *FastNode[V]) all6() func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
		if n == nil {
			return
		}
...
func (n *FastNode[V]) allSorted4() func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
		if n == nil {
			return
		}
...
func (n *FastNode[V]) allSorted6() func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
		if n == nil {
			return
		}
...
func TestAllIteratorsFastNode(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		...
		i := 0
		node.all4()(func(p netip.Prefix, _ int) bool {
			i++
			got = append(got, p)
			if i >= n/2 {
				return false
		...
		got = nil
		i = 0
		node.allSorted4()(func(p netip.Prefix, _ int) bool {
			i++
			got = append(got, p)
			if i >= n/2 {
				return false
		...
		sort.Slice(pfxs, func(i, j int) bool {
			return LessPrefix(pfxs[i], pfxs[j])
		})
...
func TestSubnets4FastNode(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		...
		sort.Slice(allPfxsSorted, func(i, j int) bool {
			return LessPrefix(allPfxsSorted[i], allPfxsSorted[j])
		})
