...
func TestLiteNode_Iterators(t *testing.T) {
	...
	count := 0
	n.AllIndices()(func(u uint8, val int) bool {
		count++
		if val != 0 {
	...
	// AllChildren
	childCount := 0
	n.AllChildren()(func(addr uint8, child any) bool {
		childCount++
		if child == nil {
...
func TestLiteDeleteCompare4(t *testing.T) {
	...
	for i := 0; i < probes; i++ {
		...
		lite.allSorted4()(func(pfx netip.Prefix, s struct{}) bool {
...
func TestLiteDeleteCompare6(t *testing.T) {
	...
	for i := 0; i < probes; i++ {
		...
		collect := []netip.Prefix{}
		lite.allSorted6()(func(pfx netip.Prefix, s struct{}) bool {
			collect = append(collect, pfx)
			return true
		})
