...
// helpers
func (n *LiteNode[V]) all4() func(yield func(netip.Prefix, V) bool) {
...
func (n *LiteNode[V]) all6() func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
		if n == nil {
			return
		}
...
func (n *LiteNode[V]) allSorted4() func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
		if n == nil {
			return
		}
...
func (n *LiteNode[V]) allSorted6() func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
		if n == nil {
			return
		}
