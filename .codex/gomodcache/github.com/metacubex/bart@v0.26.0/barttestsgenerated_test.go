...
import (
	...
	"github.com/metacubex/bart/internal/tests/golden"
	"github.com/metacubex/bart/internal/tests/random"
)
...
func (t *Table[V]) flatSorted() golden.Table[V] {
	...
	t.AllSorted()(func(p netip.Prefix, v V) bool {
...
func TestTableModifySemantics_Table(t *testing.T) {
	...
	for _, tt := range tests {
		...
		tbl.All()(func(pfx netip.Prefix, val int) bool {
			got[pfx] = val
			return true
		})
...
func TestTableSize_Table(t *testing.T) {
	...
	tbl.AllSorted4()(func(prefix netip.Prefix, a any) bool {
		allCount4++
		return true
	})

	tbl.AllSorted6()(func(prefix netip.Prefix, a any) bool {
		allCount6++
		return true
	})
...
func TestTableAll_Table(t *testing.T) {
	...
	tbl.All()(func(pfx netip.Prefix, val string) bool {
	...
	tbl.All4()(func(pfx netip.Prefix, val string) bool {
	...
	tbl.All6()(func(pfx netip.Prefix, val string) bool {
...
func TestTableAllSorted_Table(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			tbl.AllSorted()(func(pfx netip.Prefix, i int) bool {
			...
			tbl.AllSorted4()(func(pfx netip.Prefix, i int) bool {
			...
			tbl.AllSorted6()(func(pfx netip.Prefix, i int) bool {
...
func TestTableSubnets_Table(t *testing.T) {
	...
	t.Run("empty table", func(t *testing.T) {
		...
		tbl.Subnets(pfx)(func(prefix netip.Prefix, s string) bool {
	...
	t.Run("invalid prefix", func(t *testing.T) {
		...
		val := "foo"
		tbl.Insert(pfx, val)
		tbl.Subnets(zeroPfx)(func(prefix netip.Prefix, s string) bool {
	...
	t.Run("identity", func(t *testing.T) {
		...
		tbl.Subnets(pfx)(func(p netip.Prefix, v string) bool {
			if p != pfx {
	...
	t.Run("default gateway", func(t *testing.T) {
		...
		dg4 := mpp("0.0.0.0/0")
		got4 := 0
		tbl.Subnets(dg4)(func(prefix netip.Prefix, i int) bool {
			got4++
			return true
		})
		...
		dg6 := mpp("::/0")
		got6 := 0
		tbl.Subnets(dg6)(func(prefix netip.Prefix, i int) bool {
			got6++
			return true
		})
...
func TestTableSubnetsCompare_Table(t *testing.T) {
	...
	for _, pfx := range random.RealWorldPrefixes(prng, n) {
		...
		t.Run("subtest", func(t *testing.T) {
			...
			gotTbl := []netip.Prefix{}
			tbl.Subnets(pfx)(func(pfx netip.Prefix, i int) bool {
...
func TestTableSupernetsEdgeCase_Table(t *testing.T) {
	...
	t.Run("identity", func(t *testing.T) {
		...
		tbl.Supernets(pfx)(func(p netip.Prefix, v string) bool {
			if p != pfx {
...
func TestTableSupernetsCompare_Table(t *testing.T) {
	...
	for _, pfx := range random.RealWorldPrefixes(prng, n) {
		...
		t.Run("subtest", func(t *testing.T) {
			...
			tbl.Supernets(pfx)(func(p netip.Prefix, i int) bool {
